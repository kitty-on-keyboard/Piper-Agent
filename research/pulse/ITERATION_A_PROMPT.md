> **Superseded (2026-09-21):** 4-way Pulse is KILL. Ship KEEP-seed is Stage-0 + binary force/nudge — see `research/pulse/PULSE_FORCE_BINARY_KEEP_SEED_2026-09-21.md` and `docs/PULSE.md`.
