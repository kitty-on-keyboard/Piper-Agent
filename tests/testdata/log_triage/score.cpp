// Scoreboard for the shipped log-triage engine against the committed corpus.
//
...
//
//   cmake --build build --target log_triage_score_shipped
//   ./build/log_triage_score_shipped -v
//
#include "corpus.hpp"
