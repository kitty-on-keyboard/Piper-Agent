...
//
// PATH CONTAINMENT IS TEXTUAL AND NOTHING IS stat()ed. This matches labelling rule 1 of
// bakeoff/blast_radius: `/work/repo/../repo/build` is inside `/work/repo`. Containment
// answered by text is a predicate about a string, and it is honest about being one. It
// is NOT an authorization: S7.1 is absolute that authorization comes from the OS, and
// nothing in this header may ever be the thing that decides a command may run.
//
#include <cstddef>
#include <string>
#include <string_view>
