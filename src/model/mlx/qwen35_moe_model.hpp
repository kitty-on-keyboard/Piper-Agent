...
public:
    ...
    mx::array forward_moe(int layer, const mx::array& x) const {
        ...
        // mx::array has no default ctor — assign only from moe_topk returns.
        const std::pair<mx::array, mx::array> routed =
            (wrap.k1 == wrap.k2)
        ...
        const mx::array& inds = routed.first;
        const mx::array& scores = routed.second;
